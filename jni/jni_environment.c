/*
 * Fixed JNI Environment - Removed duplicate functions
 * Only contains the JNI function table, not the accessor functions
 */
...
/*
 * INITIALIZATION FUNCTION - NO LONGER PROVIDES ACCESSOR FUNCTIONS
 */
